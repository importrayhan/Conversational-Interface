"""
# Chatbot
Solara is a react like framework for python
This is a way to create a chatbot using OpenAI's GPT-4 API, utilizing their new API, and the streaming feature.
code snippet from https://solara.dev/documentation/examples/ai/chatbot
"""
